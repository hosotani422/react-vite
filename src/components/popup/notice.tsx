...
export default (props: { notice: typeof notice }): JSX.Element | undefined => {
  if (props.notice.state.open) {
    return (
      <div
      ...
      >
        ...
        <InputButton data-testid="NoticeBack" className="flex-initial text-theme-fine" onClick={() => props.notice.temp.callback()}>
