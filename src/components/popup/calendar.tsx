  ...
  return (
    ...
    >
            ...
            >
              { month.day.map((day) =>
                <li
                  ...
                  onClick={() => props.calendar.temp.callback(day.id)}
                >
                  { day.text }
                </li>
              ) }
      ...
      <div className="flex flex-initial justify-end gap-3">
        ...
        <InputButton data-testid="CalendarClear" className="flex-initial text-theme-warn" onClick={() => props.calendar.temp.callback(``)}>
