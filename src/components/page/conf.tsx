    ...
    >
      ...
      >
        ...
        >
          ...
          <p data-testid="ConfTitle" className="flex-1 text-xl">{ app.temp.i18next.t(`conf.title`) }</p>
          <p data-testid="ConfName" className="flex-initial">{ `${constant.base.app.name} ${constant.base.app.version}` }</p>
        </div>
        <ul data-testid="ConfBody" className="flex-1 overflow-auto p-3">
          ...
          >
            <p data-testid="ConfSizeTitle" className="flex-[0_1_5rem]">{ app.temp.i18next.t(`conf.size.title`) }</p>
            <InputRange
            ...
            />
            <p data-testid="ConfSizeName" className="flex-initial">{ app.temp.i18next.t(`conf.size.value.${props.conf.state.data.size}`) }</p>
          </li>
          <li
            data-testid="ConfItem"
            className="theme-color-border theme-color-back flex h-16 items-center gap-3 border-b-[0.1rem] border-solid p-3"
          >
            <p data-testid="ConfSpeedTitle" className="flex-[0_1_5rem]">{ app.temp.i18next.t(`conf.speed.title`) }</p>
            <InputRange
            ...
            />
            <p data-testid="ConfSpeedName" className="flex-initial">{ app.temp.i18next.t(`conf.speed.value.${props.conf.state.data.speed}`) }</p>
          </li>
          <li
            data-testid="ConfItem"
            className="theme-color-border theme-color-back flex h-16 items-center gap-3 border-b-[0.1rem] border-solid p-3"
          >
            <p data-testid="ConfThemeTitle" className="flex-1">{ app.temp.i18next.t(`conf.theme.title`) }</p>
            <InputRadio
            ...
            >
              { app.temp.i18next.t(`conf.theme.value.light`) }
            </InputRadio>
            <InputRadio
              ...
              onChange={(e) => props.conf.handle.inputValue({ type: `theme`, value: (e.target as HTMLInputElement).value })}
            >
              { app.temp.i18next.t(`conf.theme.value.dark`) }
            </InputRadio>
          </li>
          <li
            data-testid="ConfItem"
            className="theme-color-border theme-color-back flex h-16 items-center gap-3 border-b-[0.1rem] border-solid p-3"
          >
            <p data-testid="ConfLangTitle" className="flex-1">{ app.temp.i18next.t(`conf.lang.title`) }</p>
            <InputRadio
            ...
            >
              { app.temp.i18next.t(`conf.lang.value.en`) }
            </InputRadio>
            <InputRadio
              ...
              onChange={(e) => props.conf.handle.inputValue({ type: `lang`, value: (e.target as HTMLInputElement).value })}
            >
              { app.temp.i18next.t(`conf.lang.value.ja`) }
            </InputRadio>
          </li>
          <li
            data-testid="ConfItem"
            className="theme-color-border theme-color-back flex h-16 items-center gap-3 border-b-[0.1rem] border-solid p-3"
          >
            <p data-testid="ConfVibrateTitle" className="flex-1">{ app.temp.i18next.t(`conf.vibrate.title`) }</p>
            <InputRadio
            ...
            >
              { app.temp.i18next.t(`conf.vibrate.value.off`) }
            </InputRadio>
            <InputRadio
              ...
              onChange={(e) => props.conf.handle.inputValue({ type: `vibrate`, value: (e.target as HTMLInputElement).value })}
            >
              { app.temp.i18next.t(`conf.vibrate.value.on`) }
            </InputRadio>
          </li>
          <li
            data-testid="ConfItem"
            className="theme-color-border theme-color-back flex h-16 items-center gap-3 border-b-[0.1rem] border-solid p-3"
          >
            <p data-testid="ConfSaveTitle" className="flex-1">{ app.temp.i18next.t(`conf.save.title`) }</p>
            <InputRadio
            ...
            >
              { app.temp.i18next.t(`conf.save.value.local`) }
            </InputRadio>
            <InputRadio
              ...
              onChange={(e) => props.conf.handle.inputValue({ type: `save`, value: (e.target as HTMLInputElement).value })}
            >
              { app.temp.i18next.t(`conf.save.value.rest`) }
            </InputRadio>
            <InputRadio
              ...
              onChange={(e) => props.conf.handle.inputValue({ type: `save`, value: (e.target as HTMLInputElement).value })}
            >
              { app.temp.i18next.t(`conf.save.value.gql`) }
            </InputRadio>
          </li>
          <li
            data-testid="ConfItem"
            className="theme-color-border theme-color-back flex h-16 items-center gap-3 border-b-[0.1rem] border-solid p-3"
          >
            <p data-testid="ConfBackupTitle" className="flex-1">{ app.temp.i18next.t(`conf.backup.title`) }</p>
            <a
              data-testid="ConfBackupDownload"
              className="flex-[0_1_2rem] text-theme-fine"
              onClick={(e) => props.conf.handle.downloadBackup({ listId: params.listId!, elem: e.currentTarget as HTMLElement })}
            >
              <InputButton>
                { app.temp.i18next.t(`conf.backup.download`) }
              </InputButton>
            </a>
            <InputFile
              ...
              >{ app.temp.i18next.t(`conf.backup.upload`) }</InputFile
            >
          </li>
          <li
            data-testid="ConfItem"
